...
ROLES = {
    ...
    "developer": {
        ...
        "commands": [
            ...
            "git --version",
            "git -C /home/lab status 2>/dev/null || true",
            "git -C /home/lab log --oneline -3 2>/dev/null || true",
            "ls -la /home/lab/",
            "find /home/lab -name '*.py' -maxdepth 2 2>/dev/null | head -10",
            "cat /home/lab/.bashrc | head -5",
            "wc -l /home/lab/.bashrc",
        ],
    },
    "analyst": {
        "weight": 0.2,
    ...
    "user": {
        ...
        "commands": [
            ...
            "which bash",
            "cal 2>/dev/null || true",
            "ls -la /home/lab/Downloads/ 2>/dev/null || true",
        ],
    },
}
